...
class RegionScanWaitThread(QThread):
    """
    区域目标识别线程（支持绝对/相对区域）
    ...
    def __init__(self, parent, target_class, region_params, timeout_seconds=1, min_confidence=0.5, window_target=None, global_model=None, processing_interval=0.5):
    ...
    def scan_single_frame_region(self, frame, x1, y1, x2, y2):
        ...
        try:
            ...
            if self.global_model:
                results = list(self.global_model(region, verbose=False, stream=True, imgsz=416))
